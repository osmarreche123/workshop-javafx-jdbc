...
public class DepartmentListController implements Initializable, DataChangeListener {
    ...
    public void onButtonNovoAction(ActionEvent event){
        ...
        createDialogForm(obj, "/gui/DepartmentForm.fxml", parenteStage);
    }
    ...
    private void removeEntity(Department obj) {
        ...
        Optional<ButtonType> result = Alerts.showConfirmation("Confirmation", "Tem certeza que deseja remover o objeto?");
